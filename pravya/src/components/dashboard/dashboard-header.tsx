...
import { Menu, User, Settings, LogOut, PanelLeftClose, PanelLeft } from "lucide-react"
...
export function DashboardHeader({ session }: DashboardHeaderProps) {
  ...
  return (
    <>
      <header className="sticky top-0 z-50 bg-black/95 backdrop-blur-sm border-b border-neutral-800">
        <div className="flex items-center justify-between px-6 py-4">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="w-56 bg-neutral-950 border-neutral-800" align="end">
              ...
              <DropdownMenuSeparator className="bg-neutral-800" />
              <DropdownMenuItem className="text-white hover:bg-neutral-900" onClick={handleSignOut}>
      ...
      <MobileSidebar open={mobileSidebarOpen} onClose={() => setMobileSidebarOpen(false)} session={session} />
    </>
  )
}
