        ...
        <div className="max-w-4xl mx-auto p-6">
          ...
          <div className="space-y-8">
            ...
            <Card className="bg-gray-900 border-gray-800">
              <CardHeader>
                <CardTitle className="text-white">Update Profile Image</CardTitle>
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div className="flex-1">
                      <Input
                        ...
                        className="bg-gray-800 border-gray-700 text-white file:bg-gray-700 file:text-white file:border-0 file:rounded-md file:px-4 file:py-2 file:mr-4 hover:bg-gray-700 focus:ring-2 focus:ring-white/20"
                      />
                    </div>
                  </div>
                  <Button
